...
#IdeaVault by Dom: This Toll is for me, and idiot with way to many ideas.
...
print(create_idea(
    title = input("Whats the Title of this Idea: "),
    description = input("describe the Idea: "),
    category = input("Category: "),
    potential = int(input("input the potential as a Number")),
    next_step = input("whats the next step?: ")
))
